...
public class AppInfo {
	...
	public static final int VERSION_PATCH     = 24;
	public static final String VERSION        = R.string.title_activity_main + " v1.0.24-rc2"; //an alias as a quickway to get version number instead of concat string
